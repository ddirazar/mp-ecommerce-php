...
if(isset($parametros["collection_status"])) {
    switch( $parametros["collection_status"] ) {
        case "pending":
            $resultado = "Su pago está pendiente en proceso. Le notificaremos cuando se haya registrado";
            break;
        case "rejected":
            $resultado = "Su pago ha sido rechazado";
            break;
        case "approved":
    ...
    $resultado = "No se ha podido procesar su pago";
